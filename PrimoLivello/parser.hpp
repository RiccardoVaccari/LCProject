...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // globalvar
      char dummy5[sizeof (GlobalVarAST*)];
      ...
      // stmts
      char dummy13[sizeof (std::vector<StmtAST*>)];
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_block = 36,                            // block
        S_vardefs = 37,                          // vardefs
        S_binding = 38,                          // binding
        S_exp = 39,                              // exp
